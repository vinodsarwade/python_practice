...
print(name.capitalize())  # it will capitalize the first charactor of string and all other charactor converted in to small
...
print(str1.find("is"))         #it will  first find the element "is" present or not ,if present then it will give index 
