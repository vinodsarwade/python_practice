...
#python supportsa wide varity of function and methods like set(), list(), dict(),ord(),int(),float(),str(),tuple()for the typecasting in python.

a =  "1"  #  2 str need to add so need to convert first in to int so use typecasting
b = "2" 
print(int(a)+int(b))
